...
\begin{proof}
$(\rightarrow)$ Suppose $A \triangle B \subseteq C$. Let $x$ be arbitrary and suppose $x \in A \cup C$. Thus $x \in A$ or $x \in C$.  If $x \in C$ then $x \in B \cup C$. In the case that $x \in A$ then $x \notin C$ and it follows that $x \notin A \triangle B$ and thus $x \in A \cap B$. Since $x \in A \cap B$, $x \in B$ and thus $x \in B \cup C$. Now to prove the other direction suppose $x \in B \cup C$. Thus $x \in B$ or $x \in C$. If $x \in C$ then $x \in B \cup C$. In the case that $x \in B$ then $x \notin C$ and it follows that $x \notin A \triangle B$ and thus $x \in A \cap B$. Since $x \in A \cap B$, $x \in A$ and thus $x \in A \cup C$.
